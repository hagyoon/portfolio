/* ──────────────────────────────────────────────────────────────────────────
 * Contact section — "Begin a conversation" opens the ContactModal.
 * ────────────────────────────────────────────────────────────────────────── */
      ...
      >
        ...
        <Reveal delay={0.2}>
          <button
            ...
            className="mt-12 font-serif italic text-2xl md:text-3xl tracking-tight text-ink hover:text-clay transition-colors duration-300 cursor-pointer"
          >
...
function ContactLine({ label, href, display }: { label: string; href: string; display: string }) {
  return (
    <div>
